...
const config = {
  ...
  tagline: 'Learn everything you need to know',
  ...
  organizationName: 'CommunityOne', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/getcommunityone/delta-spark-handbook/',
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/communityone-social-card.jpg',
      navbar: {
        title: 'CommunityOne',
        logo: {
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} CommunityOne Documentation.`,
      },
      prism: {
